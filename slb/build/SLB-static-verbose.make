...
ifeq ($(config),debug)
  OBJDIR     = obj/Debug/SLB-static-verbose
  TARGETDIR  = bin/static
  TARGET     = $(TARGETDIR)/libSLB.a
  DEFINES   += -DSLB_LIBRARY -DSLB_DYNAMIC_LIBRARY=0 -DSLB_DEBUG_LEVEL=5
  INCLUDES  += -I../include
...
ifeq ($(config),release)
  OBJDIR     = obj/Release/SLB-static-verbose
  TARGETDIR  = bin/static
  TARGET     = $(TARGETDIR)/libSLB.a
  DEFINES   += -DSLB_LIBRARY -DSLB_DYNAMIC_LIBRARY=0 -DSLB_DEBUG_LEVEL=5
  INCLUDES  += -I../include
...
$(TARGET): $(GCH) $(OBJECTS) $(LDDEPS) $(RESOURCES)
	@echo Linking SLB-static-verbose
	$(SILENT) $(LINKCMD)
	$(POSTBUILDCMDS)
...
clean:
	@echo Cleaning SLB-static-verbose
ifeq (posix,$(SHELLTYPE))
	$(SILENT) rm -f  $(TARGET)
	$(SILENT) rm -rf $(OBJDIR)
else
