...
ifeq ($(config),debug)
  OBJDIR     = obj/Debug/SLB-dynamic
  TARGETDIR  = bin/dynamic
  TARGET     = $(TARGETDIR)/libSLB.dylib
  DEFINES   += -DSLB_LIBRARY -DSLB_DYNAMIC_LIBRARY=1
  INCLUDES  += -I../include
...
ifeq ($(config),release)
  OBJDIR     = obj/Release/SLB-dynamic
  TARGETDIR  = bin/dynamic
  TARGET     = $(TARGETDIR)/libSLB.dylib
  DEFINES   += -DSLB_LIBRARY -DSLB_DYNAMIC_LIBRARY=1
  INCLUDES  += -I../include
